...
module.exports = async function(config, template, slug, sheetID, app) {

  var sheetOpsFactory = require("./sheetOps"),
      { copySheet } = sheetOpsFactory(app);
  ...
  try {
    ...
    console.log("Couldn't make a snapshot of installed dependencies for the manifest -- does your graphics repo have a package.json?");
